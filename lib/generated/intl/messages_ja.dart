...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "checkSentence1" : MessageLookupByLibrary.simpleMessage("バッグの登録には、「バッグの名前」「もちもの」両方の入力が必要です。\nこのまま戻ると、このバッグは登録されませんがよろしいですか。"),
    "checkSentence2" : MessageLookupByLibrary.simpleMessage("「バッグの名前」あるいは「もちもの」のいずれかが削除されました。\nこのまま戻ると、このバッグが削除されますがよろしいですか。"),
    ...
    "resetSentence2" : MessageLookupByLibrary.simpleMessage("「用意済みのもちもの」を\n「まだ用意していないもちもの」へ\n移動しますか？"),
    "resetSentence3" : MessageLookupByLibrary.simpleMessage("用意する前の状態にしました"),
    "selectColor" : MessageLookupByLibrary.simpleMessage("テーマカラーを選ぶ"),
    ...
    "warmingSentence" : MessageLookupByLibrary.simpleMessage("もちものはピン留めされたもちもの以外は、全てまだ用意していないもちものになります")
  };
}
